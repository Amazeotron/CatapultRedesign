...
}(window), cataCommon.init(), $(".post-box").hover(function() {
    $(this).addClass("hover");
}, function() {
    $(this).removeClass("hover");
});

var $twitterContainer = $("#js-twitter-list"), $twitterItems = $twitterContainer.find(".twitter-list__item"), tick = 0, offset = 0, ticker = setInterval(function() {
    if (tick < $twitterItems.length - 4) {
        var activeItem = $twitterItems.eq(tick);
        offset -= activeItem.height() + 40, $twitterContainer.transition({
            y: offset
        }, 650, "easeInOutQuad"), tick++;
