...
function ParsePostType() {
    var _callback = null, _data = null, _init = function(url, callback) {
        _callback = callback, $.getJSON(url, function(data) {
            _handleDataLoaded(data);
        }).error(function(error) {
            console.log("ParsePostType error parsing URL:"), console.log(error);
        });
    }, _handleDataLoaded = function(data) {
        console.log("ParsePostType data loaded."), _data = data, _callback(_data.posts);
    }, _getPosts = function() {
        return _data.posts;
    };
    return {
...
(function(t) {
    ...
    function n(t) {
        function n(t) {
            if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                var T = e(n.height);
                return T !== !1 && (h.height = T + (b ? 0 : y + E)), h.innerWidth = h.width - (m + _), 
                h.innerHeight = h.height - (y + E), h.outerWidth = h.width + g, h.outerHeight = h.height + v, 
                h;
            }
        }
        var o, a = t("boxSizing");
    ...
    function i(t, i, n) {
        ...
        r.prototype._transitionTo = function(t, e) {
            ...
            a = u.isOriginLeft ? a : -a, h = u.isOriginTop ? h : -h, p.transform = c(a, h), 
            this.transition({
                to: p,
        ...
        return r.prototype.removeTransitionStyles = function() {
            ...
            if (!s || !parseFloat(this.layout.options.transitionDuration)) return this.removeElem(), 
            void 0;
            var t = this;
    ...
    function r(i, r, u, c, l, m) {
        function y(t, i) {
            if ("string" == typeof t && (t = s.querySelector(t)), !t || !f(t)) return a && a.error("Bad " + this.settings.namespace + " element: " + t), 
            void 0;
    ...
    var s = t.document, a = t.console, h = t.jQuery, p = function() {}, u = Object.prototype.toString, f = "object" == typeof HTMLElement ? function(t) {
    ...
    function _tweetAnimationDone() {
        tick == Math.round($twitterItems.length / 2) && ($twitterContainer.transition({
            y: 0
        }, 0, "linear"), tick = 0, offset = 0);
    }
    cataCommon.init(), $(".post-box").hover(function() {
        $(this).addClass("hover");
    }, function() {
        $(this).removeClass("hover");
    });
    var $twitterContainer = $("#js-twitter-list"), $twitterItems = $twitterContainer.find(".twitter-list__item"), tick = 0, offset = 0, delay = 4e3;
    setInterval(function() {
        var activeItem = $twitterItems.eq(tick);
        offset -= activeItem.height() + 40, $twitterContainer.transition({
            y: offset
        }, 650, "easeInOutQuad", _tweetAnimationDone), tick++;
    }, delay);
});