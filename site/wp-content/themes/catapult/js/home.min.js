...
var map = {
    init: function() {
        ...
        function showMapCallout(data) {
            ...
            var img = $('<img src="/wp-content/themes/catapult/getimageurl.php?imageID=' + data.custom_fields.image[0] + '" />'), loc = data.location.address, $h2 = _callout.find("h2");
        ...
        _map.on("click", function(event) {
            console.log(event), hideMapCallout();
...
$(document).ready(function() {
    ...
    cataCommon.init(), $(window).scroll(function() {
        ...
        scrollPos > 100 ? ($(".logo .logo--full").removeClass("show").addClass("hide"), 
