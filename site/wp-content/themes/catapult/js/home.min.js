...
var map = {
    init: function() {
        ...
        function filterCasestudies(data, category) {
            var inCatItems = [];
            return _.each(data, function(project) {
                _.each(project.categories, function(cat) {
                    cat.slug == category && inCatItems.push(project);
                });
            }), inCatItems;
        }
        ...
        function showMapCallout(data) {
            ...
            var img = $('<img src="/wp-content/themes/catapult/getthumburl.php?imageID=' + data.custom_fields.image[0] + '&width=200&height=200" />'), loc = data.location.address, $h2 = _callout.find("h2");
        ...
        var southWest = new L.LatLng(-69.41124, -227.10937), northEast = new L.LatLng(84.47406, 202.5), _map = new L.Map("locations-map", {
            scrollWheelZoom: !1,
        ...
        var _callout = $("#map-callout"), _mapIcon = L.icon({
            ...
            shadowSize: [ 41, 41 ],
            shadowAnchor: [ 16, 39 ]
        }), _locsURL = "/api/get_posts/?post_type=project&custom_fields=client_name,disabled,slug,category,locations,image&count=-1&callback=?", _markers = new L.MarkerClusterGroup({
        ...
        _map.on("click", function() {
            ...
            $(this).addClass("active"), $("body").animate({
                scrollTop: 1071
            }, 500), redrawMarkersWithFilter($(this).data("tag"));
        });
    }
}, team = {
    _teamData: null,
...
$(document).ready(function() {
    ...
    cataCommon.init(), $(window).scroll(function() {
        ...
        match: function() {
            _shouldShowBigLogo = !1;
        },
        unmatch: function() {
            _shouldShowBigLogo = !0;
        }
    });
