<ul class="team-members">
					<li class="team-member primary">
						<img src="<?php bloginfo('template_url'); ?>/img/homepage/team/heather.jpg" />
					...
					<li class="team-member primary">
						<img src="<?php bloginfo('template_url'); ?>/img/homepage/team/tyler.jpg" />
						<div class="team-member-details">
					...
					<li class="team-member primary">
						<img src="<?php bloginfo('template_url'); ?>/img/homepage/team/noel.jpg" />
						<div class="team-member-details">
					...
					<li class="team-member primary">
						<img src="<?php bloginfo('template_url'); ?>/img/homepage/team/charlie.jpg" />
						<div class="team-member-details">
					...
					<li class="team-member secondary">
						<img src="<?php bloginfo('template_url'); ?>/img/homepage/team/tom.jpg" />
						<div class="team-member-details">
					...
					<li class="team-member secondary">
						<img src="<?php bloginfo('template_url'); ?>/img/homepage/team/dawn.jpg" />
						<div class="team-member-details">
					...
					<li class="team-member tertiary">
						<img src="<?php bloginfo('template_url'); ?>/img/homepage/team/graham.jpg" />
						<div class="team-member-details">
					...
					<li class="team-member tertiary">
						<img src="<?php bloginfo('template_url'); ?>/img/homepage/team/hristo.jpg" />
						<div class="team-member-details">
					...
					<li class="team-member tertiary">
						<img src="<?php bloginfo('template_url'); ?>/img/homepage/team/lauren.jpg" />
						<div class="team-member-details">
					...
					<li class="team-member tertiary">
						<img src="<?php bloginfo('template_url'); ?>/img/homepage/team/nathalie.jpg" />
						<div class="team-member-details">
					...
					<li class="team-member tertiary">
						<img src="<?php bloginfo('template_url'); ?>/img/homepage/team/brian.jpg" />
						<div class="team-member-details">
					...
					<li class="team-member tertiary">
						<img src="<?php bloginfo('template_url'); ?>/img/homepage/team/gary.jpg" />
						<div class="team-member-details">
