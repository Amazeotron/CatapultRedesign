      ...
      <div id="posts">
        <article class="post">
          ...
          <!--<div class="event-date">-->
            ...
            */
            ?>
            <h4>When: <? $date = DateTime::createFromFormat('Ymd', get_field('date')); echo $date->format('M d, Y'); ?></h4>
            <h4>Starts: <? the_field('start_time'); ?></h4>
            <h4>Ends: <? the_field('end_time'); ?></h4>
          ...
          <div class="post-map">
            <h4>Location:</h4>
            <p><?php $location = get_field('location'); echo $location['address']; ?></p>
